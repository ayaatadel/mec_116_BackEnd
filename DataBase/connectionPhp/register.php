...
<body>
    ...
    <label for="name" class="form-control m-3 p-2">User Name</label>
    <input class="form-control m-3 p-2" type="text" name="name" id="name">
    ...
    <button type="submit" class="btn btn-primary m-5" name="BtnRegister">Register</button>
